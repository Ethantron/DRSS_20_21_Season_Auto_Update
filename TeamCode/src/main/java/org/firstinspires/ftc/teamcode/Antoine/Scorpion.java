package org.firstinspires.ftc.teamcode.Antoine;
...
public class Scorpion extends LinearOpMode{
	...
	private final InitHardware robot = new InitHardware();  //Load hardware from hardware map
		...
		gamepadHandler = new Thread(new Runnable() {
			...
			public void run() {
				while (canRunGamepadThread) {
					...
					telemetry.addData("TeleDrive", gamepadAction);
					telemetry.update();
